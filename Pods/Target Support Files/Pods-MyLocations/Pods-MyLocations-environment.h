...
// RHManagedObject
#define COCOAPODS_POD_AVAILABLE_RHManagedObject
#define COCOAPODS_VERSION_MAJOR_RHManagedObject 0
#define COCOAPODS_VERSION_MINOR_RHManagedObject 14
#define COCOAPODS_VERSION_PATCH_RHManagedObject 0
